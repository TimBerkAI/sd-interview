...
class Templates(Base):
    ...
    specialty: Mapped[SpecialityEnum] = mapped_column(SAEnum(SpecialityEnum, name='arch_specialty'), nullable=False)
    status: Mapped[TemplateStatusEnum] = mapped_column(
        SAEnum(TemplateStatusEnum, name='arch_template_status'),
        nullable=False,
        default=TemplateStatusEnum.DRAFT,
    )

    sections = relationship(
        'arch.models.sections.Sections',
