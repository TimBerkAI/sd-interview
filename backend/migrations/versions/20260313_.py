...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_rooms_template_id"), "rooms", ["template_id"], unique=False
    )
    op.create_table(
        "room_answers",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_room_answers_room_id"), "room_answers", ["room_id"], unique=False
    )
    op.create_index(
        op.f("ix_room_answers_section_id"), "room_answers", ["section_id"], unique=False
    )
